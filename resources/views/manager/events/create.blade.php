                ...
                <form method="POST" action="{{ route('events.store') }}">
                    ...
                    <div class="md:flex justify-between items-end">
                        ...
                        <div class="flex space-x-4 justify-around items-center">
                            <input class="mr-2" type="radio" name="is_visible" value="1" checked /><span class="ml-2">表示</span>
                            <input class="mr-2" type="radio" name="is_visible" value="0" /><span class="ml-2">非表示</span>
                        </div>
